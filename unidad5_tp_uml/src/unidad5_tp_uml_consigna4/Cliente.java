...
public class Cliente {
    ...
    private TarjetaDeCredito tarjetaDeCredito; // Tarjeta de crédito asociada al cliente
    ...
    public Cliente(String nombre, int dni) {
        ...
        this.tarjetaDeCredito = null; // Inicializamos la tarjeta de crédito como nula
    }
    ...
    public TarjetaDeCredito getTarjetaDeCredito() {
        return tarjetaDeCredito; // Devolvemos la tarjeta de crédito del cliente

    }

    // Setter para asignar la tarjeta de crédito del cliente
    public void setTarjetaDeCredito(TarjetaDeCredito tarjetaDeCredito) {
        ...
        if (tarjetaDeCredito != null && tarjetaDeCredito.getTitular() != this) {
            tarjetaDeCredito.setTitular(this); // Asignamos el cliente actual como titular de la tarjeta de crédito
        }
    }

    // Método que muestra la información del cliente (Tell Don't Ask)
    public void mostrarInformacion() {
        ...
        if (tarjetaDeCredito != null) {
            tarjetaDeCredito.mostrarInformacion(); // Mostramos la información de la tarjeta de crédito
        }
    }
}
